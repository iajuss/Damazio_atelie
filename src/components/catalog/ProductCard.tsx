...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return <article className="product-card">
    {featuredMedia ? <div className="product-card__image-wrap"><Image className="product-card__image" src={featuredMedia.url} alt={featuredMedia.altText} fill sizes="(min-width: 48rem) 33vw, 100vw" /></div> : <div className="product-card__visual" aria-hidden="true" />}
